 ...
 *     // -or-
 *     return res.notActive(optionalData);
 * ```
 *
 * Or with actions2:
 * ```
...
module.exports = function notActive(optionalData) {
  ...
  if (optionalData === undefined) {
    sails.log.info('Ran custom response: res.notActive()');
    res.statusMessage = 'konga.errors.user_not_active'
  ...
  // except in production use res.sendStatus().
    ...
    sails.log.info('Custom response `res.notActive()` called with an Error:', optionalData);
